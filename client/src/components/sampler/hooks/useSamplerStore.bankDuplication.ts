...
export const runDuplicateBankPipeline = async (
  ...
  try {
    ...
    const clonedBank: SamplerBank = applyBankContentPolicy({
      ...
      disableDefaultBankShortcutLayout: false,
      disableDefaultPadShortcutLayout: false,
      pads: duplicatePads,
      sourceBankId: undefined,
      isAdminBank: false,
      exportable: true,
      bankMetadata: sourceBank.bankMetadata
        ? {
            ...
            entitlementTokenKid: undefined,
            entitlementTokenIssuedAt: undefined,
            entitlementTokenExpiresAt: undefined,
            entitlementTokenVerified: undefined,
            adminExportToken: undefined,
            adminExportTokenKid: undefined,
            adminExportTokenIssuedAt: undefined,
