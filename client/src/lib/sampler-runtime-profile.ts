...
> = {
  ...
  ios_web: {
    low: {
      kind: 'ios_web',
      tier: 'low',
      warmupPolicy: { maxPerBank: 2, maxTotal: 4, idleDelayMs: 260, maxDurationMs: 45_000, skipUnknownDuration: true },
    ...
    high: {
      kind: 'ios_web',
      tier: 'high',
      warmupPolicy: { maxPerBank: 4, maxTotal: 6, idleDelayMs: 190, maxDurationMs: 75_000, skipUnknownDuration: true },
      startupRestorePadLimit: 300,
      backgroundHydrationPadLimit: 160,
