...
alter table public.payment_reference_registry
  ...
  check (source_table in ('account_registration_requests', 'bank_purchase_requests', 'installer_purchase_requests'));
...
begin
  ...
  if p_source_table not in ('account_registration_requests', 'bank_purchase_requests', 'installer_purchase_requests') then
